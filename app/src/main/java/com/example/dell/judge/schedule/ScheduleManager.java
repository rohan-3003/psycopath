...
public class ScheduleManager {
    ...
    public void insertSchedule(String time,String monday,String tuesday, String wednesday, String thursday,String friday) {
        ...
        database.insert(DatabaseHandler.SCHEDULE_TABLE_NAME, null, contentValue);
    }
    public Cursor fetchSchedule() {
        ...
        Cursor cursor = database.query(DatabaseHandler.SCHEDULE_TABLE_NAME, columns, null, null, null, null, null);
        if (cursor != null) {
            cursor.moveToFirst();
        }
        return cursor;
